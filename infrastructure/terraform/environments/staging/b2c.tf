# Azure AD B2C Configuration for Staging Environment

module "b2c" {
  source = "../../modules/b2c"

  # B2C Tenant Configuration
  b2c_domain_name         = "userservice-staging"
  b2c_display_name        = "UserService B2C - Staging"
  country_code            = "US"
  ...
  api_identifier_uri = "https://userservice-staging.onmicrosoft.com/api"
